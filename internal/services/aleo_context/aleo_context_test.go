...
func TestAleoContext_CheckAleoContextProperties(t *testing.T) {
	assert.True(t, IsAleoContextInitialized())
...
func TestAleoContext_GenerateSignature(t *testing.T) {
	assert.True(t, IsAleoContextInitialized())
...
func TestAleoContext_FormatMessage(t *testing.T) {
	assert.True(t, IsAleoContextInitialized())
...
func TestAleoContext_HashMessage(t *testing.T) {
	// t.Skip("Skipping hash message test")
	assert.True(t, IsAleoContextInitialized())
